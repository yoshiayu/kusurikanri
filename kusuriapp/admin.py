...
from .models import User, MedicineMangement, MedicineNameManagement, TakingTimeAlarm, TakingDosage, MedicineRegister, CompanyMedicineName
...
class CompanyMedicineNameResource(resources.ModelResource):
    ...
    medicine_name = Field(attribute='medicine_name',
...
class CompanyMedicineNameAdmin(ImportExportModelAdmin):
    ...
    list_display = ('company_id', 'company_name',
                    'medicine_id', 'medicine_name', 'initials')
